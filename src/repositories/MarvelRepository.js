...
export default class MarvelRepository {
  ...
  static async fetchMoreCharacters({ offset }) {
    const uri = `https://gateway.marvel.com:443/v1/public/characters?ts=${TIMESTAMP}&apikey=${PUBLIC_APIKEY}&hash=${HASH}&limit=100&offset=${offset}`;
